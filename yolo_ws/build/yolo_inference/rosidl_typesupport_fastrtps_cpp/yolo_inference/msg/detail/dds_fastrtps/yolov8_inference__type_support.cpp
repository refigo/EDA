...
#include "yolo_inference/msg/detail/yolov8_inference__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yolo_inference::msg::InferenceResult &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const yolo_inference::msg::Yolov8Inference & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t i = 0; i < size; i++) {
      yolo_inference::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolo_inference::msg::Yolov8Inference & ros_message)
{
  // Member: header
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t i = 0; i < size; i++) {
      yolo_inference::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yolo_inference::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        yolo_inference::msg::typesupport_fastrtps_cpp::max_serialized_size_InferenceResult(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const yolo_inference::msg::Yolov8Inference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_inference::msg::Yolov8Inference *>(
    untyped_ros_message);
...
{
  return &yolo_inference::msg::typesupport_fastrtps_cpp::_Yolov8Inference__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_inference, msg, Yolov8Inference)() {
  return &yolo_inference::msg::typesupport_fastrtps_cpp::_Yolov8Inference__handle;
}
