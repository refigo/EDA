...
bool yolo_inference__msg__inference_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolo_inference.msg._inference_result.InferenceResult", full_classname_dest, 52) == 0);
  }
  yolo_inference__msg__InferenceResult * ros_message = _ros_message;
  {  // label
  ...
  {  // top_left
    ...
    assert(PyLong_Check(field));
    ros_message->top_left = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // bottom
  ...
  {  // bottom_right
    ...
    assert(PyLong_Check(field));
    ros_message->bottom_right = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // conf
...
PyObject * yolo_inference__msg__inference_result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolo_inference.msg._inference_result");
  ...
  {  // top_left
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->top_left);
    {
  ...
  {  // bottom_right
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->bottom_right);
    {
