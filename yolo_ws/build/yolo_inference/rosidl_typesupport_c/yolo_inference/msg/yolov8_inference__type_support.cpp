...
static const _Yolov8Inference_type_support_symbol_names_t _Yolov8Inference_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolo_inference, msg, Yolov8Inference)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yolo_inference, msg, Yolov8Inference)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yolo_inference, msg, Yolov8Inference)() {
  return &::yolo_inference::msg::rosidl_typesupport_c::Yolov8Inference_message_type_support_handle;
}
