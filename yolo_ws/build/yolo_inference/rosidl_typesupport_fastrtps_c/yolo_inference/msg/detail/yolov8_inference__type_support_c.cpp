...
#include "yolo_inference/msg/detail/yolov8_inference__rosidl_typesupport_fastrtps_c.h"
...
#include "yolo_inference/msg/detail/inference_result__functions.h"  // yolov8_inference

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_yolo_inference
...
using _Yolov8Inference__ros_msg_type = yolo_inference__msg__Yolov8Inference;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: yolov8_inference
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, yolo_inference, msg, InferenceResult
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _Yolov8Inference__ros_msg_type * ros_message = static_cast<_Yolov8Inference__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: yolov8_inference
  {
    ...
    if (ros_message->yolov8_inference.data) {
      yolo_inference__msg__InferenceResult__Sequence__fini(&ros_message->yolov8_inference);
    }
...
size_t get_serialized_size_yolo_inference__msg__Yolov8Inference(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Yolov8Inference__ros_msg_type * ros_message = static_cast<const _Yolov8Inference__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name yolov8_inference
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_yolo_inference__msg__InferenceResult(
...
static uint32_t _Yolov8Inference__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolo_inference__msg__Yolov8Inference(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yolo_inference
size_t max_serialized_size_yolo_inference__msg__Yolov8Inference(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: yolov8_inference
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_yolo_inference__msg__InferenceResult(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _Yolov8Inference__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yolo_inference__msg__Yolov8Inference(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolo_inference, msg, Yolov8Inference)() {
