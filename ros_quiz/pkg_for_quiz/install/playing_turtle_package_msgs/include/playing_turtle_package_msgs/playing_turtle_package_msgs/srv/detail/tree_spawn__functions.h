...
#ifndef PLAYING_TURTLE_PACKAGE_MSGS__SRV__DETAIL__TREE_SPAWN__FUNCTIONS_H_
#define PLAYING_TURTLE_PACKAGE_MSGS__SRV__DETAIL__TREE_SPAWN__FUNCTIONS_H_
...
#include "playing_turtle_package_msgs/msg/rosidl_generator_c__visibility_control.h"

#include "playing_turtle_package_msgs/srv/detail/tree_spawn__struct.h"

/// Initialize srv/TreeSpawn message.
/**
...
/// Create srv/TreeSpawn message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * playing_turtle_package_msgs__srv__TreeSpawn_Request__init().
...
/// Destroy srv/TreeSpawn message.
/**
 * It calls
 * playing_turtle_package_msgs__srv__TreeSpawn_Request__fini()
...
/// Check for srv/TreeSpawn message equality.
/**
...
/// Initialize array of srv/TreeSpawn messages.
/**
...
/// Finalize array of srv/TreeSpawn messages.
/**
 * It calls
 * playing_turtle_package_msgs__srv__TreeSpawn_Request__fini()
...
/// Create array of srv/TreeSpawn messages.
/**
 * It allocates the memory for the array and calls
 * playing_turtle_package_msgs__srv__TreeSpawn_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TreeSpawn messages.
/**
 * It calls
 * playing_turtle_package_msgs__srv__TreeSpawn_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/TreeSpawn message array equality.
/**
...
/// Copy an array of srv/TreeSpawn messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * playing_turtle_package_msgs__srv__TreeSpawn_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_playing_turtle_package_msgs
...
/**
 * It calls
 * playing_turtle_package_msgs__srv__TreeSpawn_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_playing_turtle_package_msgs
...
/**
 * It allocates the memory for the array and calls
 * playing_turtle_package_msgs__srv__TreeSpawn_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_playing_turtle_package_msgs
...
/**
 * It calls
 * playing_turtle_package_msgs__srv__TreeSpawn_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PLAYING_TURTLE_PACKAGE_MSGS__SRV__DETAIL__TREE_SPAWN__FUNCTIONS_H_
