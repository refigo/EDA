...
{
  new (message_memory) yolo_inference::msg::Yolov8Inference(_init);
}

void Yolov8Inference_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolo_inference::msg::Yolov8Inference *>(message_memory);
  typed_message->~Yolov8Inference();
}

size_t size_function__Yolov8Inference__yolov8_inference(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<yolo_inference::msg::InferenceResult> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<yolo_inference::msg::InferenceResult> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<yolo_inference::msg::InferenceResult> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const yolo_inference::msg::InferenceResult *>(
    get_const_function__Yolov8Inference__yolov8_inference(untyped_member, index));
  auto & value = *reinterpret_cast<yolo_inference::msg::InferenceResult *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<yolo_inference::msg::InferenceResult *>(
    get_function__Yolov8Inference__yolov8_inference(untyped_member, index));
  const auto & value = *reinterpret_cast<const yolo_inference::msg::InferenceResult *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Yolov8Inference_message_member_array[2] = {
  {
    ...
    offsetof(yolo_inference::msg::Yolov8Inference, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<yolo_inference::msg::InferenceResult>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_inference::msg::Yolov8Inference, yolov8_inference),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Yolov8Inference_message_members = {
  "yolo_inference::msg",  // message namespace
  "Yolov8Inference",  // message name
  2,  // number of fields
  sizeof(yolo_inference::msg::Yolov8Inference),
...
get_message_type_support_handle<yolo_inference::msg::Yolov8Inference>()
{
  return &::yolo_inference::msg::rosidl_typesupport_introspection_cpp::Yolov8Inference_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolo_inference, msg, Yolov8Inference)() {
  return &::yolo_inference::msg::rosidl_typesupport_introspection_cpp::Yolov8Inference_message_type_support_handle;
}
