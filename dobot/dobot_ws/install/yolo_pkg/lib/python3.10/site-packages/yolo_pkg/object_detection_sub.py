...
points_yellow_area = [[290, 125], [210, 66], [210, 120], [245, 110]]
...
points_red_area = [[294,-107], [211,-58], [246,-102], [207,-105]]
		...
		for each in self.curr_blocks:
			...
			if self.layer_mode == 2 or flag_valid == False:
				...
				if pnt_prp != (-1, -1):
					...
					self.run_point(self.move, [target_point[0], target_point[1], self.get_height_layer(self.layer_mode)+1, 115])
