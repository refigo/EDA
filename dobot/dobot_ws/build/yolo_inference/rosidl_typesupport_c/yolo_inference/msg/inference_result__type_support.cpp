...
static const _InferenceResult_type_support_symbol_names_t _InferenceResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolo_inference, msg, InferenceResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yolo_inference, msg, InferenceResult)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yolo_inference, msg, InferenceResult)() {
  return &::yolo_inference::msg::rosidl_typesupport_c::InferenceResult_message_type_support_handle;
}
